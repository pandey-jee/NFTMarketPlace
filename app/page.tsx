              ...
              {[1, 2, 3].map((collection) => (
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden">
                    <img
                      src={`https://img.freepik.com/free-vector/gradient-galaxy-background_52683-140335.jpg?t=st=1743655997~exp=1743659597~hmac=3f31a34103323c3cf0af936d5d449445ba914e0d011317582dd0cbb476b445d3&w=1380?height=300&width=400&text=Collection+${collection}`}
                      alt={`Collection ${collection}`}
                      className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
                    />
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold">Crypto Collection #{collection}</h3>
                    <p className="text-sm text-gray-500 mt-1">By Artist #{collection}</p>
                    <div className="mt-4 flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-500">Floor</p>
                        <p className="font-semibold">{collection * 0.5} ETH</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Volume</p>
                        <p className="font-semibold">{collection * 10} ETH</p>
                      </div>
                    </div>
                  </div>
                </div>
